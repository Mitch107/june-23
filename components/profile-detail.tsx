    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="hidden lg:block">
        <div className="grid grid-cols-3 gap-8 max-w-7xl mx-auto">
          {/* Left Column - Enlarged Photos */}
          <div className="col-span-2 space-y-4">
            {/* Main Image with Swipe - Larger */}
            <div className="relative bg-gray-100 rounded-lg group">
              <div
                ref={imageRef}
                className="w-full aspect-[4/5] flex items-center justify-center overflow-hidden cursor-pointer select-none relative"
                onTouchStart={onTouchStart}
                onTouchMove={onTouchMove}
                onTouchEnd={onTouchEnd}
              >
          ...
          <div className="col-span-1 space-y-6">
            ...
            {/* Contact Pricing - Desktop (Horizontal Layout) */}
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base">Contact Pricing</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="border rounded-lg p-3">
                    ...
                    <Button
                      className="w-full bg-pink-500 hover:bg-pink-600 text-xs py-1.5"
                      onClick={() => handleAddToCart("individual")}
                    >
                      <ShoppingCart className="w-3 h-3 mr-1" />
                      Add to Cart
                  ...
                  <div className="border rounded-lg p-3">
                    ...
                    <Button
                      variant="outline"
                      className="w-full border-pink-500 text-pink-600 hover:bg-pink-50 text-xs py-1.5"
                      onClick={() => handleAddToCart("bulk")}
                    >
                      <ShoppingCart className="w-3 h-3 mr-1" />
                      Add to Cart
